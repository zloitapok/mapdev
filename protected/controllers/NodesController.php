...
class NodesController extends Controller
{
	...
	public function actionIndex()
	{
                ...
                $cs->registerScriptFile($baseUrl . '/js/nodes.js');
                $cs->registerCssFile($baseUrl . '/css/nodes.css');
                
		$dataProvider=new CActiveDataProvider('Nodes', array(
                        'criteria'=>array(
                                'with'=>'createdBy',
                        ),
                ));
	...
	public function actionSearch()
	{
                ...
                $dataProvider = $model->fullTextSearch($search_request);
